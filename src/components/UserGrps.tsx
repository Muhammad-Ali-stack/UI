...
interface UserGrpsProps {
  authState: AuthState;
  setAuthState: React.Dispatch<React.SetStateAction<AuthState>>;
  onBackToUserManagement?: () => void;
}

const UserGrps: React.FC<UserGrpsProps> = ({ authState, setAuthState }) => {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex">
        ...
        <div className="flex-1 ml-64 pt-16 p-6">
          ...
          <p className="text-gray-600 mt-2">Hello World - User Groups Component</p>
        </div>
      </div>
    </div>
  );
